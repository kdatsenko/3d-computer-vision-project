...
int main(int argc, char** argv) {
	...
	try {
	  ...
	  desc.add_options()
	                ...
	                ("sphere_thresh,st", opt::value<float>(&sphere_thresh)->default_value(0.0025), "Sphere Distance threshold - units are relative to data pcd file, usually metres")
	                ...
	                ("max_sphere_iterations,si", opt::value<int>(&max_sphere_iterations)->default_value(500), "Maximum number of iterations to try to find a Spherical model");
